...
_TOOL_PATTERNS: tuple[tuple[str, str], ...] = (
    ...
    ("whois", r"(?<![\w./-])whois(?![\w./-])"),
    ("dig", r"(?<![\w./-])dig(?![\w./-])"),
    ("theHarvester", r"(?<![\w./-])theHarvester(?![\w./-])"),
    ("recon-ng", r"(?<![\w./-])recon-ng(?![\w./-])"),
    ("whatweb", r"(?<![\w./-])whatweb(?![\w./-])"),
    ("dirsearch", r"(?<![\w./-])dirsearch(?:\.py)?(?![\w./-])"),
    ("arjun", r"(?<![\w./-])arjun(?![\w./-])"),
    ("netcat", r"(?<![\w./-])nc(?![\w./-])|(?<![\w./-])netcat(?![\w./-])"),
    ("enum4linux", r"(?<![\w./-])enum4linux(?:-ng)?(?![\w./-])"),
    ("dnsenum", r"(?<![\w./-])dnsenum(?![\w./-])"),
    ("nikto", r"(?<![\w./-])nikto(?![\w./-])"),
    ("nuclei", r"(?<![\w./-])nuclei(?![\w./-])"),
    ("wpscan", r"(?<![\w./-])wpscan(?![\w./-])"),
    ("lynis", r"(?<![\w./-])lynis(?![\w./-])"),
    ("sqlmap", r"(?<![\w./-])sqlmap(?![\w./-])"),
    ("msfconsole", r"(?<![\w./-])msfconsole(?![\w./-])"),
    ("searchsploit", r"(?<![\w./-])searchsploit(?![\w./-])"),
    ("john", r"(?<![\w./-])john(?![\w./-])"),
    ("hashcat", r"(?<![\w./-])hashcat(?![\w./-])"),
    ("hydra", r"(?<![\w./-])hydra(?![\w./-])"),
