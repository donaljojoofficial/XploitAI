...
class CommandGeneratorTests(SimpleTestCase):
    ...
    def test_rule_based_generation_uses_phase_appropriate_tools(self):
        ...
        self.assertIn("PARAMETER_PROBE_COMPLETE", params.shell_command)
        self.assertNotIn("arjun", params.shell_command.lower())
        ...
        self.assertIn("EXPLOIT_RESEARCH_COMPLETE", exploit.shell_command)
        self.assertNotIn(" && sqlmap", exploit.shell_command)
