...
class AIPlanner:
    ...
    def _serialize_plan_step(self, attack_state, step: PlanStep, runtime_profile: Optional[dict] = None) -> dict:
    ...
    def _ensure_plan(
        ...
        attack_state.current_plan = {
            ...
            "steps": [self._serialize_plan_step(attack_state, s, runtime_profile) for s in plan.steps],
        }
